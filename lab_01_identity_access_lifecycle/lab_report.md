...
### Environment Setup
Commands were executed directly in a Linux Bash shell to simulate a live administrative session.

![CLI session overview](images/cli%20script%20command.png)
---
...
* **Evidence:** ![Task 1 - Add User](images/task1.png)
...
* **Evidence:** ![Task 2 - Assign Ownership](images/Task2.png)
...
* **Evidence:** ![Task 3 - Secondary Group](images/Task3.png)
...
* **Evidence:** ![Task 4 - Delete Retired User](images/Task4.png)
